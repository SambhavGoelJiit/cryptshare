 ...
 */
export type PaddedSize = New<{
    FR32ExpandedSize: uint64;
}>;
/**
...
export type UnpaddedPieceSize = New<{
    UnpaddedPieceSize: uint64;
}>;
export type Fr23Padded = New<{
    Fr23Padded: Uint8Array;
}>;
...
export interface MerkleTreeBuilder<I extends uint64 | number = uint64 | number> {
    clear(): this;
...
export interface PieceDigest extends StreamDigest<FR32_SHA2_256_TRUNC254_PADDED_BINARY_TREE>, Piece {
...
export type IntoProofData = [offset: uint64 | number, path: MerkleTreePath] | {
    offset: uint64 | number;
    path: MerkleTreePath;
};
