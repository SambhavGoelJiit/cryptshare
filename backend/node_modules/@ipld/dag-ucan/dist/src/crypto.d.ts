 ...
 */
export interface Signature<T = unknown, Alg extends SigAlg = SigAlg> extends ByteView<Signature<T, Alg>> {
    code: Alg;
    algorithm: string;
    /**
...
export interface AsyncVerifier<Alg extends SigAlg> {
    verify<T>(payload: ByteView<T>, signature: Signature<T, Alg>): PromiseLike<boolean>;
}
/**
